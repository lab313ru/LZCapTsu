...
procedure Help;
begin
  Writeln('-= Tecmo Cup Football Game LZ Tool v1.0 [by Lab 313] (08.03.2016) =-');
  Writeln('-----------------------------');
  ...
  Writeln('Info: This console tool allows you to compress and decompress' +
    #13#10 + '      data, packed with Tecmo Cup Football Game''s LZ77 algo.' + #13#10);
  Writeln('USAGE FOR DECOMPRESSION:' + #13#10 +
    'cui_lzcaptsu.exe [Filename] [HexOffset]' + #13#10 + 'EXAMPLE:' + #13#10 +
    'cui_lzcaptsu.exe "Tecmo Cup (J) [x].bin" 3B400' + #13#10);
  Writeln('USAGE FOR COMPRESSION:' + #13#10 + 'cui_lzcaptsu.exe [InFilename]' +
    #13#10 + 'EXAMPLE:' + #13#10 + 'cui_lzcaptsu.exe "Tecmo Cup (J) [x].3B400.bin"' + #13#10 +
    '-----------------------------' + #13#10);
end;
